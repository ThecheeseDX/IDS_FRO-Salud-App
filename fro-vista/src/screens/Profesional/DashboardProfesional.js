...
export default function DashboardProfesional({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* CU13: Acceso a episodios clínicos — cada acceso queda auditado automáticamente */}
      <TouchableOpacity
        style={styles.card}
      ...
      >
        ...
        <Text style={styles.cardText}>Consultar y registrar episodios de pacientes.</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  logoutBtn: { backgroundColor: '#d32f2f', padding: 15, borderRadius: 8, alignItems: 'center', marginTop: 10 },
